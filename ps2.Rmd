---
title: "Decriminalization of drugs in Canada"
output:
...
growing drug crisis. We surveyed Canadians across the country in each province 
in order to gain insight on the current views and knowledge of Canadians on this
subject. We found that... and it is relevant because... TODO. In the future TODO
...
somewhat supportive where as 26% of Canadians are somewhat against. This implies
...
more supportive than simulation. In a article about the topic from CBC (2019), it was 
...
battling a losing battle against a drug crisis (Government of British Columbia, 2020)
...
over doses and drug possession charges. The large amount of support in British 
Columbia can indicate possible support within other provinces as well.

In addition, the CBC article reference previously noted that the Liberal Party's
...
well as learning from previous cases of successful attempts (such as in Portugal)
