...
In addition, the CBC article (Harris, 2020) reference previously noted that the Liberal Party's
...
suggested that drug use has increased dramatically since the Covid-19 pandemic started. 
...
```{r, fig.cap="Province's support of educaion into decriminalization"}
grouped_votes <- survey_data %>%
